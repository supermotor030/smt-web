...
export default function StoreMap() {
  ...
  return (
    <div className="relative rounded-2xl overflow-hidden border border-forge-600 bg-forge-800">
      {/* Map Header */}
      ...
      <div className="h-[300px] lg:h-[350px]">
        ...
        >
          ...
          <FlyToLocation center={[STORE_LOCATION.lat, STORE_LOCATION.lng]} zoom={15} />
          
          <Marker position={[STORE_LOCATION.lat, STORE_LOCATION.lng]} icon={customIcon}>
