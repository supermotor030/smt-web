                  ...
                  <div className="relative bg-forge-800/50 backdrop-blur-sm border border-forge-600 rounded-2xl p-8 lg:p-10">
                    ...
                    <div className="flex gap-1 mb-6">
                      {[...Array(testimonial.rating)].map((_, i) => (
                        <GiSpanner key={i} className="w-5 h-5 text-warning" />
                      ))}
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                      {/* Avatar */}
                      <div className="w-12 h-12 rounded-full bg-gradient-to-br from-ignition-600 to-ignition-700 flex items-center justify-center text-white font-heading font-bold">
                        {testimonial.avatar}
                      </div>
                      <div>
                        ...
                        <p className="font-tech text-sm text-steel-400">
                          {testimonial.role}
                        </p>
                      </div>
                    </div>
            ...
            <div className="flex gap-2">
              {testimonials.map((_, index) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-sm rotate-45 transition-all duration-300 ${
                    currentIndex === index
