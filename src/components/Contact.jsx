          ...
          <div className="lg:col-span-2 space-y-4">
            {contactItems.map((item, index) => (
              <motion.div
                ...
                className="group relative bg-forge-900 rounded-xl p-5 text-white transition-all duration-300 hover:bg-forge-800"
              >
            ...
            <motion.div
              variants={itemVariants}
              className="bg-forge-900 rounded-xl p-5 text-white"
            >
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 rounded-xl bg-ignition-600/20 flex items-center justify-center flex-shrink-0">
            ...
            <motion.div variants={itemVariants} className="flex gap-3">
              <a
                ...
                className="w-12 h-12 rounded-xl bg-gray-50 flex items-center justify-center text-steel-500 hover:bg-blue-600 hover:text-white transition-all duration-300"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-12 h-12 rounded-xl bg-gray-50 flex items-center justify-center text-steel-500 hover:bg-whatsapp hover:text-white transition-all duration-300"
