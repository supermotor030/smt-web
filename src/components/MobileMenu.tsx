  ...
  return (
    <>
      ...
      >
        ...
        <motion.button
          onClick={onClose}
          className="absolute top-6 right-6 z-20 p-3 rounded-full bg-forge-800 border border-steel-800 text-steel-100 hover:text-ignition-500 hover:border-ignition-500 transition-colors"
